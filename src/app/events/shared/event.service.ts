...
export class EventService{
  getEvents(){
    // subject is a type of observable, that process stream
    let subject = new Subject();
    // here, we use next to add data in our stream
...
const EVENTS = [
  ...
  },
  {
    ...
    location: {
      adress: 'The NG-NL Convention Center & Scuba Shop',
      city: 'Amsterdam',
      country: 'Netherlands',
    },
    sessions: [
  ...
  },
  {
    ...
    location: {
      adress: 'The Palatial America Hotel',
      city: 'Salt Lake City',
      country: 'USA',
    },
    sessions: [
